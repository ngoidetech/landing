...
const Posts = tw.div`mb-6 flex flex-wrap -mr-3 relative justify-center`;
...
const Heading = styled.h1`
  ${tw`text-3xl sm:text-4xl lg:text-5xl xl:text-4xl font-black text-black text-center my-20 `}
  span {
    ${tw`inline-block`}
  }
`;
